...
{
	public class DragonSettingsGenerator : IDragonSettingsFactory
	{
	    ...
	    public DragonSettings CreateDragonSettings()
	    {
    ...
    public interface IDragonSettingsFactory
    {
        DragonSettings CreateDragonSettings();
    }
}