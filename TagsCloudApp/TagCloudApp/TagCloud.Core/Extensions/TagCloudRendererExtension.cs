...
namespace TagCloud.Core.Extensions
{
    ...
    {
        public static Result<Bitmap> Render(this ITagCloudRenderer renderer, IReadOnlyDictionary<string, Rectangle> tags)
        {
            var bitmap = renderer
            ...
            return bitmap.Execute(b => renderer.Render(Graphics.FromImage(b), tags));
        }
    }
}